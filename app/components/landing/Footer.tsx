...
export default function Footer() {
    return (
        <footer className="border-t border-surface-border bg-background pt-16 pb-8 px-6 transition-colors duration-300">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">

                {/* Brand Column */}
                <div className="md:col-span-1 flex flex-col items-start">
                    <div className="font-bold text-xl tracking-tighter flex items-center gap-2 mb-4 text-foreground">
            ...
            <div className="max-w-7xl mx-auto pt-8 border-t border-surface-border text-center text-sm text-muted-foreground">
